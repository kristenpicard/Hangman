...
// Dynamically creates letter buttons on HTML
for (i = 0; i < 26; i++) {
  var button = document.createElement("button");
  button.id = (i + 10).toString(36);
...
function updateLinesArrayWithLetterGuessed(arrayOfCharacters, letterGuessed) {
  let count = 0;
...
function showWrongGuessCount() {
  wrongGuessesDiv.innerHTML = "Incorrect Guesses: " + wrongCount + "/5";
}
showWrongGuessCount();

let userGuesses = [];

function showAllGuessedLetters() {
  lettersGuessed.innerHTML = "Letters already guessed: " + userGuesses;
}
showAllGuessedLetters();
...
function onClick(event) {
  ...
  if (arrayOfLetters.includes(userGuess)) {
    updateLinesArrayWithLetterGuessed(arrayOfLetters, userGuess);
    displayLinesArray(arrayOfLines);
